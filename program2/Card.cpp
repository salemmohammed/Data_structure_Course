...
std::map< int,std::string> getSuitNameMap(){
	...
	name_map.insert (std::pair<int,std::string>(1,"Hearts"));
	name_map.insert (std::pair<int,std::string>(2,"Spades"));
	name_map.insert (std::pair<int,std::string>(3,"Diamonds"));
	name_map.insert (std::pair<int,std::string>(4,"Clubs"));
	return name_map;
}
